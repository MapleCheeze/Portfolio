...
<!-- Describe the problem: noisy logs, cost blowouts, inconsistent schemas -- why transformation was needed -->

## Architecture

<!-- Describe the DCR-based pipeline: sources, transformations, destinations -->

## Transformations Built

<!-- Walk through specific transformations: filtering out noise, enriching with context, schema normalization -->

## Impact

<!-- Cost savings, detection quality improvements, reduced analyst fatigue -->